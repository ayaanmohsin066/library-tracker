  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        {/* Seat count */}
        <p className="text-sm tabular-nums" style={{ color: "#b9cacb", fontFamily: "var(--font-geist-mono), monospace" }}>
                ...
                <div key={loc.name} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-1.5 rounded-full" style={{ background: "rgba(59,73,75,0.4)" }}>
                    <div
                      ...
                      style={{ width: `${locPct}%`, background: locColor, transition: "width 0.65s ease" }}
                    />
                  </div>
                  <span className="text-xs font-semibold tabular-nums shrink-0" style={{ color: locColor }}>
                    {locPct}%
                  </span>
                </div>
              );
  ...
  return (
    <div className="min-h-screen p-6 md:p-8" style={{ background: "#111318" }}>
      ...
      {hasData ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
          {[1, 2, 3].map((i) => <SkeletonLibCard key={i} />)}
        </div>
      ) : isError ? (
      ...
      <div className="mt-12 pt-6" style={{ borderTop: "1px solid rgba(59,73,75,0.3)" }}>
        <p className="text-xs" style={{ color: "#849495" }}>
          Data via Waitz · Not affiliated with the University of Waterloo ·{" "}
          <a
            href="https://lib.uwaterloo.ca"
            target="_blank"
